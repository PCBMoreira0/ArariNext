...
class MavlinkToModels {
  ...
  static GpsModel toGPS(Gps gps){
    return GpsModel(latitude: gps.latitude / 1e7, longitude: gps.longitude / 1e7, speed: double.parse((gps.speed * 0.0194384).toStringAsFixed(2)), course: gps.course, heading: gps.heading, visibleSatellites: gps.satellitesVisible, hdop: gps.hdop / 10.0, timestamp: gps.timestampSeconds * 1000 + gps.timestampMilliseconds);
  }

  static BmsModel toBms(Bms bms){
    return BmsModel(voltagesMillivolts: bms.voltages, temperatures: bms.temperatures, batteryCurrent: bms.currentBattery / 10.0, stateOfCharge: bms.stateOfCharge / 10.0, timestamp: bms.timestampSeconds * 1000 + bms.timestampMilliseconds);
  }
