...
final class TemperatureData implements IBoatData {
  ...
  TemperatureData({required this.temperatureBatteryLeft, required this.temperatureBatteryRight, required this.temperatureMPPTLeft, required this.temperatureMPPTRight, required this.temperatureMotorLeft, required this.temperatureMotorRight, required this.temperatureESCRLeft, required this.temperatureESCRRight, required this.temperatureMotorCoverLeft, required this.temperatureMotorCoverRight});

  factory TemperatureData.empty() {
    return TemperatureData(temperatureBatteryLeft: 0, temperatureBatteryRight: 0, temperatureMPPTLeft: 0, temperatureMPPTRight: 0, temperatureMotorLeft: 0, temperatureMotorRight: 0, temperatureESCRLeft: 0, temperatureESCRRight: 0, temperatureMotorCoverLeft: 0, temperatureMotorCoverRight: 0);
  }
}